...
/***/ function(module, exports, __webpack_require__) {
	...
	var Headline = __webpack_require__(168);
	var Game = __webpack_require__(169);

	ReactDOM.render(React.createElement(Headline, null), document.getElementById('title'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = React.createClass({
	    ...
	    getInitialState: function () {
	        return {
	            gold: 0,
	            locations: [{ name: 'Farm', min: 10, max: 20 }, { name: 'Cave', min: 5, max: 20 }, { name: 'House', min: 2, max: 5 }, { name: 'Casino', min: -50, max: 50 }],
	            history: []
	        };
	    },
	    ...
	    render: function () {
	        ...
	        var goldSources = this.state.locations.map(function (location) {
	            return React.createElement(GoldMine, {
	                key: location.name,
	                name: location.name,
	                min: location.min,
	                max: location.max,
	...
	var GoldMine = React.createClass({
	    ...
	    render: function () {
	        if (this.props.name == 'Farm') {
	            return React.createElement(
	                'div',
	                { className: 'gold-source', id: 'farm' },
	                React.createElement('img', { src: 'assets/farm.png', alt: 'farm' }),
	                React.createElement(
	                    'h3',
	                    null,
	                    this.props.name
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'button-primary', onClick: this.goldSearch },
	        ...
	        if (this.props.name == 'Cave') {
	            return React.createElement(
	                'div',
	                { className: 'gold-source', id: 'cave' },
	                React.createElement('img', { src: 'assets/cave.png', alt: 'cave' }),
	                React.createElement(
	                    'h3',
	                    null,
	                    this.props.name
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'button-success', onClick: this.goldSearch },
	                    React.createElement('i', { className: 'fa fa-tree', 'aria-hidden': 'true' }),
	                    ' Find Gold!'
	                )
	            );
	        }
	        if (this.props.name == 'House') {
	            return React.createElement(
	                'div',
	                { className: 'gold-source', id: 'house' },
	                React.createElement('img', { src: 'assets/house.png', alt: 'house' }),
	                React.createElement(
	                    'h3',
	                    null,
	                    this.props.name
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'button-warning', onClick: this.goldSearch },
	        ...
	        if (this.props.name == 'Casino') {
	            return React.createElement(
	                'div',
	                { className: 'gold-source', id: 'casino' },
	                React.createElement('img', { src: 'assets/casino.png', alt: 'casino' }),
	                React.createElement(
	                    'h3',
	                    null,
	                    this.props.name
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'button-danger', onClick: this.goldSearch },
	...
	var SearchEvent = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            'li',
	            { className: this.props.event.outcome },
